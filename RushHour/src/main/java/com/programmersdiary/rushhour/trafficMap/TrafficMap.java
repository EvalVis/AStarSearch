...
import com.programmersdiary.rushhour.obstacles.Wall;
...
public class TrafficMap {
    ...
    public Obstacle moveCarIfPossible(Car car, Cell destinationCell) {
        ...
        return moveCarIfPossible(car, moveDirectionAndSteps.moveDirection(), moveDirectionAndSteps.steps());
    }
    ...
    private Obstacle getObstacle(Car car, int destinationX, int destinationY) {
        MoveDirectionAndSteps moveDirectionAndSteps = getMoveDirectionAndSteps(car, destinationX, destinationY);
        return getObstacle(car, moveDirectionAndSteps.moveDirection(), moveDirectionAndSteps.steps());
    }
    ...
    public record MoveDirectionAndSteps(MoveDirection moveDirection, int steps) {
    }
